...
public class Entry {
	...
	public static String loadModel(String modelFile) throws IOException {	
	    ...
	    String code = EmitCode(myObj);
	    return code;
		
	}
	
	private static String EmitCode(MAIA maia){
...
//		}
		...
		for(Plan test : maia.getOperationalStructure().getActionPlans())
		{
			 ...
			 //code = code + output(new JETTemplates.EntityAction_instance().generate(test),"EntityAction");
		}
		return code;
	...
	private static String output(String code, String n) {
