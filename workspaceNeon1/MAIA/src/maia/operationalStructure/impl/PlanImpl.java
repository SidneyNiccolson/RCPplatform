 ...
 * </p>
 * <ul>
 *   <li>{@link maia.operationalStructure.impl.PlanImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PlanImpl extends MinimalEObjectImpl.Container implements Plan {
	...
	protected EClass eStaticClass() {
		return OperationalStructurePackage.Literals.PLAN;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OperationalStructurePackage.PLAN__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OperationalStructurePackage.PLAN__NAME:
				return getName();
		}
