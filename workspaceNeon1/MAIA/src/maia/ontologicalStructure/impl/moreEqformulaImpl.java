...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>more Eqformula</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link maia.ontologicalStructure.impl.moreEqformulaImpl#getLeftConditionStatement <em>Left Condition Statement</em>}</li>
 *   <li>{@link maia.ontologicalStructure.impl.moreEqformulaImpl#getRightConditionStatement <em>Right Condition Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class moreEqformulaImpl extends MathConditionImpl implements moreEqformula {
	/**
	...
	protected EClass eStaticClass() {
		return OntologicalStructurePackage.Literals.MORE_EQFORMULA;
	}
		...
		if (leftConditionStatement != null && leftConditionStatement.eIsProxy()) {
			...
			if (leftConditionStatement != oldLeftConditionStatement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OntologicalStructurePackage.MORE_EQFORMULA__LEFT_CONDITION_STATEMENT, oldLeftConditionStatement, leftConditionStatement));
			}
		}
	...
	public void setLeftConditionStatement(Condition newLeftConditionStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologicalStructurePackage.MORE_EQFORMULA__LEFT_CONDITION_STATEMENT, oldLeftConditionStatement, leftConditionStatement));
	}
	...
	public Condition getRightConditionStatement() {
		if (rightConditionStatement != null && rightConditionStatement.eIsProxy()) {
			...
			if (rightConditionStatement != oldRightConditionStatement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OntologicalStructurePackage.MORE_EQFORMULA__RIGHT_CONDITION_STATEMENT, oldRightConditionStatement, rightConditionStatement));
			}
		}
	...
	public void setRightConditionStatement(Condition newRightConditionStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologicalStructurePackage.MORE_EQFORMULA__RIGHT_CONDITION_STATEMENT, oldRightConditionStatement, rightConditionStatement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntologicalStructurePackage.MORE_EQFORMULA__LEFT_CONDITION_STATEMENT:
				if (resolve) return getLeftConditionStatement();
				return basicGetLeftConditionStatement();
			case OntologicalStructurePackage.MORE_EQFORMULA__RIGHT_CONDITION_STATEMENT:
