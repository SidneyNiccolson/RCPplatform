...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>equal Formula</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link maia.ontologicalStructure.impl.equalFormulaImpl#getLeftConditionStatement <em>Left Condition Statement</em>}</li>
 *   <li>{@link maia.ontologicalStructure.impl.equalFormulaImpl#getRightConditionStatement <em>Right Condition Statement</em>}</li>
 * </ul>
 *
 * @generated
 */
public class equalFormulaImpl extends MathConditionImpl implements equalFormula {
	/**
	...
	protected EClass eStaticClass() {
		return OntologicalStructurePackage.Literals.EQUAL_FORMULA;
	}
		...
		if (leftConditionStatement != null && leftConditionStatement.eIsProxy()) {
			...
			if (leftConditionStatement != oldLeftConditionStatement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OntologicalStructurePackage.EQUAL_FORMULA__LEFT_CONDITION_STATEMENT, oldLeftConditionStatement, leftConditionStatement));
			}
		}
	...
	public void setLeftConditionStatement(Condition newLeftConditionStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologicalStructurePackage.EQUAL_FORMULA__LEFT_CONDITION_STATEMENT, oldLeftConditionStatement, leftConditionStatement));
	}
	...
	public Condition getRightConditionStatement() {
		if (rightConditionStatement != null && rightConditionStatement.eIsProxy()) {
			...
			if (rightConditionStatement != oldRightConditionStatement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, OntologicalStructurePackage.EQUAL_FORMULA__RIGHT_CONDITION_STATEMENT, oldRightConditionStatement, rightConditionStatement));
			}
		}
	...
	public void setRightConditionStatement(Condition newRightConditionStatement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologicalStructurePackage.EQUAL_FORMULA__RIGHT_CONDITION_STATEMENT, oldRightConditionStatement, rightConditionStatement));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntologicalStructurePackage.EQUAL_FORMULA__LEFT_CONDITION_STATEMENT:
				if (resolve) return getLeftConditionStatement();
				return basicGetLeftConditionStatement();
			case OntologicalStructurePackage.EQUAL_FORMULA__RIGHT_CONDITION_STATEMENT:
