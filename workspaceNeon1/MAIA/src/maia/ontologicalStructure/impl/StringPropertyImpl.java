 ...
 * </p>
 * <ul>
 *   <li>{@link maia.ontologicalStructure.impl.StringPropertyImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringPropertyImpl extends PropertyImpl implements StringProperty {
	...
	protected EClass eStaticClass() {
		return OntologicalStructurePackage.Literals.STRING_PROPERTY;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OntologicalStructurePackage.STRING_PROPERTY__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case OntologicalStructurePackage.STRING_PROPERTY__VALUE:
				return getValue();
		}
