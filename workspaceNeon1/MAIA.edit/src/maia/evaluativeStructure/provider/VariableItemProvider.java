...
/**
 * This is the item provider adapter for a {@link maia.evaluativeStructure.Variable} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VariableItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EvaluativeStructurePackage.Literals.VARIABLE__LABEL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EvaluativeStructurePackage.Literals.VARIABLE__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Variable)object).getLabel();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Variable.class)) {
			case EvaluativeStructurePackage.VARIABLE__LABEL:
			case EvaluativeStructurePackage.VARIABLE__VALUE:
